...
for _, kataDiKamus in ipairs(databaseAktif) do
	...
	if #kataDiKamus >= 3
	and string.sub(kataDiKamus, 1, #inputTeks) == inputTeks
	and not KataTerpakai[kataDiKamus] then
...
langBtn.MouseButton1Click:Connect(function()
    ...
    if not isEnglishMode and #KamusInggris == 0 then
        searchInput.PlaceholderText = "Loading English DB..."
        return
    end

    local currentText = searchInput.Text
    ...
    searchInput.PlaceholderText =
        isEnglishMode and "Search English word..."
        or "Cari kata Indonesia..."

    KataTerpakai = {}

    searchInput.Text = currentText -- pertahankan pencarian
